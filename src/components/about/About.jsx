  ...
  return (
    <div className="a" id="profil">
      ...
      <div className="a-left">
        ...
        <p  className="a-desc-bottom">Aujourd'hui je parfaire mes compétences <br/> et me spéciale dans <span className='bold-span'>Node.js</span> et <span className='bold-span'>React</span>.</p>
      </div>
