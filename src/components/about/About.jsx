  ...
  return (
    <div className="a" id="profil">
      ...
      <div className="a-left">
        ...
        <p className="a-desc-bottom" data-aos='fade-up' data-aos-duration="2500" data-aos-offset="-700">Aujourd'hui je me spécialise <span className='bold-span'> frontend </span>et réalise le <br/><span className='bold-span'> maximum</span> de projet pour continuer à <span className='bold-span'>progresser</span>.</p>
      </div>
